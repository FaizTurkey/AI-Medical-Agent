export const AIDoctorAgents = [
    {
        ...
        image: "/Faizimage.jpeg",
        agentPrompt: "You are a friendly General Physician AI. Greet the user and quickly ask what symptoms they are experiencing.Keep responses short and helpful.",
        voiceId: "kumar",
